...
![Setting the Runspace ID](.gitbook/assets/image%20%2821%29.png)
...
![Selecting the PowerShell Process](.gitbook/assets/image%20%2813%29.png)

After selecting the process, VS Code will break into the endpoint's script block. 

![VS Code debugging an Endpoint](.gitbook/assets/image%20%283%29.png)
...
![Evaluating the $Request Variable](.gitbook/assets/image%20%2822%29.png)
